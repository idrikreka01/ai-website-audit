    ...
    for cat in categories:
        ...
        <div style="margin-bottom: 15px;">
            <div style="display: flex; align-items: center; margin-bottom: 5px;">
                ...
                <div style="flex: 1; background: #ecf0f1; height: 25px; border-radius: 3px; margin-left: 10px; position: relative;">
                    <div style="background: #3498db; height: 100%; width: {bar_width}%; border-radius: 3px; display: flex; align-items: center; justify-content: flex-end; padding-right: 5px;">
                        <span style="color: white; font-size: 10px; font-weight: bold;">{percentage:.0f}%</span>
                    </div>
                </div>
            </div>
        </div>
