            ...
            if question and tier and severity and page:
                try:
                    ...
                    if severity_int < 1 or severity_int > 5:
                        print(f"Warning: Invalid severity {severity_int} for question: {question[:50]}...")
                        continue
                    
                    page_normalized = normalize_page_type(page)
                    if page_normalized not in ['homepage', 'product', 'cart', 'checkout', 'navigation', 'collection', '404']:
                        print(f"Warning: Invalid page type '{page}' for question: {question[:50]}...")
                        continue
                    ...
                    print(f"Warning: Invalid tier/severity for question: {question[:50]}... Error: {e}")
                    continue
